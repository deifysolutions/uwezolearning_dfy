...
ynh_send_readme_to_admin() {
	...
	local mail_message="This is an automated message from your beloved Ibeads server.
...
---
Automatic diagnosis data from Ibeads
...
ynh_install_php71 () {
  ...
  sudo update-alternatives --install /usr/bin/php php /usr/bin/php5 71
}
